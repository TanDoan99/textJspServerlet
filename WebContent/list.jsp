	...
	<div>
		<table >
			...
			<tr>
				...
				<td>
					 <a href="<%=request.getContextPath()%>/EditProduct?bookId=<%=objBook.getBookId()%>"alt="edit">Sửa  </a>
                     <a href="<%=request.getContextPath()%>/Delete?bookId=<%=objBook.getBookId()%>" onclick="return confirm('Bạn có chắc chắn muốn xóa không?')">Xóa </a>
				</td>
			</tr>
				<%}} %>
		</table>
